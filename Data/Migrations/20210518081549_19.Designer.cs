...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.MarketSubComponentPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("MarketSubComponentPhoto");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "f0bd3289-b416-40b8-b462-16d6883e5260",
                            Name = "Manager",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "f3175033-36b8-4688-89d6-bf3dbe050858",
                            Name = "Admin",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b11a87d5-668c-460c-ac30-d176c4d220ec",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedUserName = "POLYMER_MANAGER",
                            PasswordHash = "AQAAAAEAACcQAAAAED0wGsetCBMr/nnzEJf0ZvI178WGwJDbznmElwbIHpKsUl/hnSeh5SWkrkNP+hY2Cg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "8940437b-b393-4d9a-b29a-b50c457d8dab",
            ...
            modelBuilder.Entity("Core.Models.MarketSubComponentPhoto", b =>
                {
                    b.HasOne("Core.Models.MarketSubComponent", "MarketSubComponent")
                        .WithMany("MarketSubComponentPhotos")
                        .HasForeignKey("MarketSubComponentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Models.MarketSubComponent", b =>
                {
                    ...
                    b.Navigation("MarketSubComponentPhotos");
                });
